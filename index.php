    ...
    <div class="row">
        ...
        <div class="col-12 col-sm-6 col-lg-3">
            <div class="single_advisor_profile wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                ...
                <div class="advisor_thumb">
                    <a href="ANDREW_ONEAL.php"><img src="assets\images\headshot.jpg" alt=""></a>
                    <!-- Social Info-->
        ...
        <div class="col-12 col-sm-6 col-lg-3">
            <div class="single_advisor_profile wow fadeInUp" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">
                <!-- Team Thumb-->
                <div class="advisor_thumb">
                    <a href="detail.php"><img src="https://bootdey.com/img/Content/avatar/avatar7.png" alt=""></a>
                    <!-- Social Info-->
                    <div class="social-info">
                        <a href=""><i class="fa fa-facebook"></i></a><a href="detail.php"><i class="fa fa-twitter"></i></a><a href="detail.php"><i class="fa fa-linkedin"></i></a>
                    </div>
                </div>
                <!-- Team Details-->
                <div class="single_advisor_details_info">
